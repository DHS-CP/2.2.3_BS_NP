...
public class ApplicantActivity extends AppCompatActivity
    ...
    private static final String BE_APP_ID = "YOUR_BACKENDLESS_APP_ID";
    private static final String BE_ANDROID_API_KEY = "YOUR_BACKENDLESS_ANDROID_API_KEY";
    public  static final String EMAIL_PREF = "EMAIL_PREF";
    private static final String MY_EMAIL_ADDRESS = "";
